...
configtest = load_object("data/configSIS_timevarying.jld2")
...
margtest = load_object("data/margSIS_timevarying.jld2")
...
n_iter_nc = 10
damp_nc = 0.3
@testset "inferenceSIS_timevarying_nc" begin
    Random.seed!(rng, 1)
...
@testset "inferenceSISscheme" begin
    ...
    margtestscheme = load_object("data/margSISscheme_timevarying.jld2")
...
n_iter_nc = 10
damp_nc = 0.3
@testset "inferenceSISscheme_timevarying_nc" begin
    Random.seed!(rng, 1)
