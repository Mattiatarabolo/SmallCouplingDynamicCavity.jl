...
configtest= load_object("data/configSI_timevarying.jld2")
...
margtest = load_object("data/margSI_timevarying.jld2")
...
@testset "inferenceSIscheme_timevarying" begin
    ...
    margtestscheme = load_object("data/margSIscheme_timevarying.jld2")
