...
"""
SIS(εᵢᵗ::Union{Float64,Array{Float64,2}}, rᵢᵗ::Union{Float64,Array{Float64,2}}, NV::Int, T::Int)
...
function nodes_formatting(
    model::EpidemicModel{SIS,AbstractGraph}, 
    obsprob::Function)

    nodes = Vector{Node{SIS,AbstractGraph}}()
...
"""
    sim_epidemics(model::EpidemicModel{SIS,TG}; patient_zero=nothing, γ=nothing)
